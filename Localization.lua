...
-- Russian translation ZamestoTV
local locale = GetLocale()
if locale == "ruRU" then
    L = {
    -- Main messages
    ["ADDON_LOADED"] = "FoxChat загружен. Введите /fc или /foxchat для открытия настроек.",
    ["SETTINGS_SAVED"] = "FoxChat: Настройки сохранены",
    ["DEFAULTS_RESTORED"] = "FoxChat: Настройки сброшены до значений по умолчанию",
    
    -- Settings window
    ["CONFIG_TITLE"] = "Настройки FoxChat",
    ["KEYWORDS_LABEL"] = "Фильтруемые ключевые слова:",
    ["KEYWORDS_HELP"] = "Введите слова для выделения (разделяйте запятыми)",
    ["IGNORE_KEYWORDS_LABEL"] = "Игнорируемые ключевые слова:",
    ["IGNORE_KEYWORDS_HELP"] = "Сообщения с этими словами не будут фильтроваться",
    ["ENABLED"] = "Включить FoxChat",
    ["PLAY_SOUND"] = "Воспроизводить звуковое оповещение",
    ["CHANNELS_AND_COLORS"] = "Мониторинг каналов и цвета:",
    ["CHANNEL_GROUP_GUILD"] = "Гильдия",
    ["CHANNEL_GROUP_PUBLIC"] = "Общие",
    ["CHANNEL_GROUP_PARTY_RAID"] = "Группа/Рейд",
    ["CHANNEL_GROUP_LFG"] = "Поиск группы",
    ["CHANNEL_SAY"] = "Сказать",
    ["CHANNEL_YELL"] = "Крик",
    ...
    ["CHANNEL_WHISPER"] = "Шепот",
    ["CHANNEL_GENERAL"] = "Общий",
    ["CHANNEL_TRADE"] = "Торговля",
    ["CHANNEL_LFG"] = "Поиск группы",
    ["TEST_BUTTON"] = "Тест",
    ["SAVE_BUTTON"] = "Сохранить",
    ["CLOSE_BUTTON"] = "Закрыть",
    ["RESET_BUTTON"] = "Сбросить на значения по умолчанию",
    ["TEST_MESSAGE"] = "Это тестовое сообщение с вашими ключевыми словами!",
    ["SOUND_VOLUME"] = "Громкость звука:",
    ["HIGHLIGHT_STYLE"] = "Стиль выделения:",
    ["STYLE_BOLD"] = "Жирный",
    ["STYLE_COLOR"] = "Только цвет",
    ["STYLE_BOTH"] = "Жирный + Цвет",
    
    -- Prefix/Suffix
    ["PREFIX_LABEL"] = "Префикс сообщения:",
    ["SUFFIX_LABEL"] = "Суффикс сообщения:",
    ["PREFIX_SUFFIX_HELP"] = "Автоматически добавляет текст перед и после ваших сообщений",
    ["PREFIX_SUFFIX_CHANNELS"] = "Применить к каналам:",
    
    -- Section headers
    ["SECTION_CHAT_FILTER"] = "Настройки фильтрации чата",
    ["SECTION_PREFIX_SUFFIX"] = "Настройки префикса/суффикса",
    
    -- Commands
    ["COMMANDS_HEADER"] = "Команды FoxChat:",
    ["COMMAND_CONFIG"] = "  /fc - Открыть настройки",
    ["COMMAND_TOGGLE"] = "  /fc toggle - Включить/выключить аддон",
    ["COMMAND_ADD"] = "  /fc add <ключевое слово> - Добавить ключевое слово",
    ["COMMAND_REMOVE"] = "  /fc remove <ключевое слово> - Удалить ключевое слово",
    ["COMMAND_LIST"] = "  /fc list - Показать текущие ключевые слова",
    
    -- Status
    ["STATUS_ENABLED"] = "FoxChat: Включен",
    ["STATUS_DISABLED"] = "FoxChat: Выключен",
    ["KEYWORD_ADDED"] = "FoxChat: Добавлено ключевое слово '%s'",
    ["KEYWORD_REMOVED"] = "FoxChat: Удалено ключевое слово '%s'",
    ["KEYWORD_NOT_FOUND"] = "FoxChat: Ключевое слово '%s' не найдено",
    ["CURRENT_KEYWORDS"] = "Текущие ключевые слова: %s",
    ["NO_KEYWORDS"] = "Ключевые слова не настроены",
    
    -- Minimap button
    ["LEFT_CLICK_TOGGLE"] = "ЛКМ: Включить/Выключить",
    ["LEFT_CLICK_TOGGLE_FILTER"] = "ЛКМ: Включить/Выключить фильтр",
    ["RIGHT_CLICK_CONFIG"] = "ПКМ: Открыть настройки",
    ["ENABLED"] = "Включено",
    ["DISABLED"] = "Выключено",
    ["FILTER_ENABLED"] = "Фильтрация чата включена",
    ["FILTER_DISABLED"] = "Фильтрация чата выключена",
    ["FILTER_STATUS_ENABLED"] = "Фильтр: ВКЛ",
    ["FILTER_STATUS_DISABLED"] = "Фильтр: ВЫКЛ",
    ["FILTER_ENABLE"] = "Включить фильтрацию чата",
    ["PREFIX_SUFFIX_ENABLE"] = "Включить префикс/суффикс",
    ["RESET_KEYWORDS"] = "Сбросить ключевые слова",
    ["KEYWORDS_RESET"] = "Ключевые слова сброшены",
    ["SHOW_MINIMAP_BUTTON"] = "Показывать кнопку на миникарте",
    
    -- Default values
    ["DEFAULT_KEYWORDS"] = "ЛФГ,Продам,Куплю",
}	
end
